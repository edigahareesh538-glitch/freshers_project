...
async function fetchParticipants() {
    const response =await fetch("https://freshers-project.onrender.com/participants");
...
async function searchByRoll() {
    ...
    try{
        const res = await fetch(`https://freshers-project.onrender.com/participants/roll/${roll}`);
...
async function deleteUser(id) {
    ...
    const res= await fetch(`https://freshers-project.onrender.com/participants/${id}`, {
        method: "DELETE"
    });
    const data=await res.json();
    alert(data.message);
